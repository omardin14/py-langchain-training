...
This directory contains sample documents used by the LangChain demo modules for testing document loaders, splitters, and storage.

## Files

- `sample_document.pdf` - Sample PDF document for testing PDF loaders
- `sample_data.csv` - Sample CSV file for testing CSV loaders
